...
Go to `File > Add Package Dependencies...`, paste `https://github.com/pickerweng/tenmax-mobileads-ios-sdk` into package URL. After the package is found, you can indicate the exact version of SDK. Then, click the `Add Package` to add the SDK package into your Xcode project.
...
```swift
dependencies: [
    .package(url: "https://github.com/pickerweng/tenmax-mobileads-ios-sdk", .upToNextMajor(from: "0.0.2"))
]
```
...
let package = Package(
    ...
    targets: [
        .target(
            name: "YourTargetName",
            dependencies: [
              .product(name: "TenMaxMobileAdsSDK", package: "tenmax-mobileads-ios-sdk")
            ],
        ),
    ]
)
...
```ogdl
binary "https://raw.githubusercontent.com/pickerweng/tenmax-mobileads-ios-sdk/main/TenMaxMobileAdsSDK.json"
```
